...
interface TimelineGridProps {
  tracks?: { id: string; [key: string]: unknown }[];
  groups?: unknown[];
...
const TimelineGrid: React.FC<TimelineGridProps> = ({
  ...
  function renderTrackLane(track: { id: string; [key: string]: unknown }) {
  ...
  return (
    <div className={styles.gridArea} style={containerStyle}>
      ...
      <div className={styles.trackLanes}>{content}</div>
    </div>
  );
};
