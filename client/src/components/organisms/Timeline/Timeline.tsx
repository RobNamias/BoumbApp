...
import type { TimelineGroup } from "./TimelineLibrary";
...
const Timeline: React.FC<TimelineProps> = ({
  ...
  return (
    <div className={styles.timelineContainer}>
      <ModuleHeader title="Skyline" icon={Layers} color="#bb86fc" />

      <div className={styles.workspace}>
        {/* Left Panel: Library (Drawers) */}
        <TimelineLibrary groups={groups} onDragStart={handleDragStart} />
